 ...
 * @author User
 */
public class AlterarAnamnesePaciente extends javax.swing.JFrame {
     ...
     */
    public AlterarAnamnesePaciente() {
        initComponents();
        readcampos();
    }
...
public class JPanelGradient2 extends JPanel{
    ...
    private void BtnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVoltarActionPerformed
        // TODO add your handling code here:
        ExibirAnamnesesPaciente tp = new ExibirAnamnesesPaciente();
        tp.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarAnamnesePaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarAnamnesePaciente().setVisible(true);
            }
        });
    }
