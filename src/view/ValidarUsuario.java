...
//Adiciona o Gradiente
    ...
    private void txtCRPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCRPKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){ 
        boolean dadosvalidos = true;
        String msg = "Existem campos com formatos Inválidos\n\nFavor Verificar os campos:";
        Psicologo p = new Psicologo();
    ...
    }//GEN-LAST:event_txtCRPKeyPressed
