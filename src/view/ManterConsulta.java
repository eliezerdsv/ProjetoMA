 ...
 * @author User
 */
public class ManterConsulta extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(Horario, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void BtnCadastrarConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCadastrarConsultaActionPerformed
        if (JTPacienteSimples.getSelectedRow() != -1) {
            ...
            String datatxt = Data.getText();
            String horariotxt = Horario.getText();
            horariotxt = horariotxt.concat(":00");
            String date_time = datatxt + " " + horariotxt;
            //Utiliza a data do calendario para escolher a data
            SimpleDateFormat sdf= new SimpleDateFormat("dd/MM/yyyy");
            String dataCalendario=sdf.format(DateChooser.getDate());
            // System.out.println("data "+ date_time);

            java.util.Date dataFormatada = null;
            try {
                dataFormatada = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").parse(date_time);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterConsulta().setVisible(true);
            }
        });
    }
